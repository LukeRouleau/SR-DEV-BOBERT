/* 
    \--------------------------------------------------------------------------------------------------------------\
    \ Luke Rouleau & Xuanhao Shi 2022                                                                              \
    \ Senior Design x IEEE Southeast Con Hardware Design Competition                                               \
    \--------------------------------------------------------------------------------------------------------------\
    \ This represents the final Teensy code for Bobert. It combines the functionality of the motor control         \
    \ interface & the arm hardware interface.                                                                      \
    \--------------------------------------------------------------------------------------------------------------\
*/
